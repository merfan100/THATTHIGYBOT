...
# --- نقشه روزهای رویداد برای پیام تایید (بر اساس درخواست شما) ---
DYNAMIC_CONFIRM_DAY = {
    "tehran": "جمعه",  # روز رویداد تهران
    "esfahan": "سه‌شنبه", # ⭐️ اصلاح شد به سه‌شنبه ⭐️
    "shiraz": "رویداد شیراز", # در صورت مشخص شدن روز، اینجا ویرایش شود
}
# -------------------------------------------------------------
